...
runTests(testGroup({
  'function isEmpty(any)': subject(O.isEmpty,
    {
      '({}) => true': function (topic) {
  ...
  'function isPrimitive(any)': subject(O.isPrimitive,
    {
  ...
  'function isArray(any)': subject(O.isArray,
    {
      '([]) => true': function (topic) {
          return topic([]).to_be(true);
        },
  ...
  'function supplement(default, value, [callback])': subject(O.supplement,
    {
      ...
      '(default, value, callback) => callback(default, value)': function (topic) {
          return topic(1, -1, Math.max).to_be(1);
        }
    }),
  'function asArray(any)': subject(O.asArray,
    {
